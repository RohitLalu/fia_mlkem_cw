...
FYI:
Please do have basic understanding of Make, Jupyter Notebooks, Python and the CW API for a smooth learning experience. Its easier to use these notebooks as is as well but its better to understand what you are working on as well.


Link to some results I have got throughout my time at IISc performing these tasks:
  https://docs.google.com/presentation/d/15AtB19s2wE7BtvqXC0XZRddD1-iltlSKsfobtmbh7eo/
